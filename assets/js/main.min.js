...
updateCluster:function(a){n.update(a)},clearHTML:function(a){document.getElementById(a).innerHTML=""},sendResponse:function(a){$.ajax({type:"POST",url:"https://cors.io/?u=https://seminic.000webhostapp.com/pibic/propespqr/access_presence_list.php",crossDomain:!0,data:{dados:JSON.stringify(a)},cache:!1,success:function(a){console.log("Sincronizado com sucesso");b.onSendSuccess(a)},error:function(a,c,d){b.onSendError(a,c,d)}})},onSendSuccess:function(a){console.log(a);b.animate._changeSyncStatus();b.animate._syncing(!1);
b.animate._showToast("Sincronizado com sucesso.")},onSendError:function(a,c,d){b.animate._changeSyncStatus();b.animate._syncing(!1);b.animate._showToast("Erro ao sincronizar.");console.error(a.responseText);console.error("Erro ao sincronizar ("+c+"): "+d)},sync:function(){b.animate._syncing(!0);b.animate._showToast("Sincronizando...");$.ajax({url:"https://cors.io/?u=https://seminic.000webhostapp.com/pibic/propespqr/retrieve_scholarship_holders.php",success:function(a){var c,d,e,g=b.data.length,h=
