  ...
  window.MaterialMenu = d, d.prototype.Constant_ = {
    ...
    if (this.element_ && this.forElement_) {
      ...
      this.element_.classList.contains(this.CssClasses_.UNALIGNED) || (this.element_.classList.contains(this.CssClasses_.BOTTOM_RIGHT) ?
        ...
        (this.container_.style.right = "0", this.container_.style.top = "0") :
        ...
        // Original: (this.container_.style.left = this.forElement_.offsetLeft + "px", this.container_.style.top = this.forElement_.offsetTop + this.forElement_.offsetHeight + "px"))
        // Modification: (this.container_.style.left = "0", this.container_.style.top = "10px"))
        (this.container_.style.left = "0", this.container_.style.top = "10px"))
    }
    this.toggle(e)
    ...
    if (this.element_ && this.container_ && this.outline_) {
      ...
      // Original: document.addEventListener("click", o)
      // Modification: document.addEventListener("mousedown", o)
