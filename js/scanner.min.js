...
qrScan.log("QR Code inv\u00e1lido! Escaneie um QR Code pertencente \u00e0 PROPESP."))},animate:{_snap:function(){document.getElementById("cameraCanvas");$("#cameraCanvas").addClass("snap-anim").one("webkitAnimationEnd oanimationend msAnimationEnd animationend",function(a){$("#cameraCanvas").removeClass("snap-anim")})},_success:function(){$(".success").removeClass("snap-status-in snap-status-out").addClass("snap-status-in");setTimeout(function(){$(".success").removeClass("snap-status-in").addClass("snap-status-out")},
3E3)},_error:function(){$(".error").removeClass("snap-status-in snap-status-out").addClass("snap-status-in");setTimeout(function(){$(".error").removeClass("snap-status-in").addClass("snap-status-out")},3E3)}}};null===localStorage.getItem("enableLog")||"false"===localStorage.getItem("enableLog")?qrScan.enableLog(!1):"true"===localStorage.getItem("enableLog")&&qrScan.enableLog(!0);var options={},options=qrScan.initVideoObjectOptions("webcameraPreview");qrScan.initScanner(options);
