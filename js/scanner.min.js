...
var qrScan={data:[],initHtmlElement:function(a){return document.getElementById(a)},initVideoObjectOptions:function(a){scanner={};return{video:qrScan.initHtmlElement(a),continuous:!0,mirror:!1,captureImage:!1,backgroundScan:!1,refractoryPeriod:3E3,scanPeriod:1}},initAvaliableCameras:function(a){Instascan.Camera.getCameras().then(function(b){a()})},initCamera:function(a){scanner.stop();Instascan.Camera.getCameras().then(function(a){if(0<a.length){var b=a[0];$.each(a,function(a,g){if(-1!=g.name.indexOf("back"))return b=
g,!1});console.log(b);scanner.start(b)}else alert("Nenhuma camera encontrada.")})},scanStart:function(a){scanner.addListener("scan",function(b){a(b)})},initScanner:function(a){scanner=new Instascan.Scanner(a)},saveScannedData:function(a){console.log("Dados lidos: "+a);var b=a.replace(/\n/gi,""),b=b.replace(/\\"/g,'"');console.log("Dados processados: "+b);var h=JSON.stringify(qrScan.data);console.log("Dados salvos em RAM: "+h);b.match(/^\x7b\"\x70\x72\x6f\x70\x65\x73\x70\"\: \x7b(.*)\x7d\x7d/g)?(qrScan.data.push(JSON.parse(a)),
