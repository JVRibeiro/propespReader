...
qrScan.log("QR Code inv\u00e1lido! Escaneie um QR Code pertencente \u00e0 PROPESP."),qrScan.animate._showToast("QR Code inv\u00e1lido!"))},animate:{_snap:function(){$("#cameraCanvas").removeClass("snap-anim");$("#cameraCanvas").addClass("snap-anim").one("webkitAnimationEnd oanimationend msAnimationEnd animationend",function(a){$("#cameraCanvas").removeClass("snap-anim")})},_showToast:function(a){var b=document.querySelector(".mdl-js-snackbar");void 0!==toastTimeout&&clearTimeout(toastTimeout);$(".mdl-js-snackbar").removeClass("mdl-snackbar--active");
