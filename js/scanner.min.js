...
a)):(qrScan.animate._snap(),qrScan.animate._error(),console.log("QR Code inv\u00e1lido! Escaneie um QR Code pertencente \u00e0 PROPESP."),qrScan.log("QR Code inv\u00e1lido! Escaneie um QR Code pertencente \u00e0 PROPESP."))},animate:{_snap:function(){document.getElementById("cameraCanvas");$("#cameraCanvas").addClass("snap-anim").one("webkitAnimationEnd oanimationend msAnimationEnd animationend",function(a){$("#cameraCanvas").removeClass("snap-anim")})},_success:function(){$(".success").hasClass("snap-status-out")?
$(".success").removeClass("snap-status-out").addClass("snap-status-in"):$(".success").addClass("snap-status-in");setTimeout(function(){$(".success").removeClass("snap-status-in").addClass("snap-status-out")},3E3)},_error:function(){$(".error").hasClass("snap-status-out")?$(".error").removeClass("snap-status-out").addClass("snap-status-in"):$(".error").addClass("snap-status-in");setTimeout(function(){$(".error").removeClass("snap-status-in").addClass("snap-status-out")},3E3)}}},options={},options=
qrScan.initVideoObjectOptions("webcameraPreview");qrScan.initScanner(options);qrScan.initAvaliableCameras(function(){cameraId=1});qrScan.initCamera(cameraId);qrScan.scanStart(function(a){qrScan.saveScannedData(a)});
