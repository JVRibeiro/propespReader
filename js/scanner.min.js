...
b,!1});console.log(h);scanner.start(h)}else alert("Nenhuma camera encontrada.")})},scanStart:function(a){scanner.addListener("scan",function(g){a(g)})},initScanner:function(a){scanner=new Instascan.Scanner(a)},saveScannedData:function(a){a=a.replace(/\n/gi,"");qrScan.data.propesp.push(JSON.parse(a));var g=JSON.stringify(a);console.log("Dados lidos: "+g);a=a.replace(/\\"/g,'"');console.log("Dados processados: "+a);JSON.stringify(qrScan.data.propesp);a.match(/^\x7b\"\x70\x72\x6f\x70\x65\x73\x70\"\:\x5b\x7b(.*)\x7d\x5d\x7d/g)?
