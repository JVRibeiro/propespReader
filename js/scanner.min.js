...
$jscomp.owns=function(a,b){return Object.prototype.hasOwnProperty.call(a,b)};$jscomp.polyfill=function(a,b,c,d){if(b){c=$jscomp.global;a=a.split(".");for(d=0;d<a.length-1;d++){var g=a[d];g in c||(c[g]={});c=c[g]}a=a[a.length-1];d=c[a];b=b(d);b!=d&&null!=b&&$jscomp.defineProperty(c,a,{configurable:!0,writable:!0,value:b})}};
...
c("seal");var g=0,e=function(a){this.id_=(g+=Math.random()+1).toString();if(a){$jscomp.initSymbol();$jscomp.initSymbolIterator();a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};e.prototype.set=function(a,c){b(a);if(!$jscomp.owns(a,d))throw Error("WeakMap key fail: "+a);a[d][this.id_]=c;return this};e.prototype.get=function(a){return $jscomp.owns(a,d)?a[d][this.id_]:void 0};e.prototype.has=function(a){return $jscomp.owns(a,d)&&$jscomp.owns(a[d],this.id_)};e.prototype["delete"]=
...
$jscomp.initSymbolIterator();var b=new WeakMap,c=function(a){this.data_={};this.head_=e();this.size=0;if(a){a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};c.prototype.set=function(a,b){var c=d(this,a);c.list||(c.list=this.data_[c.id]=[]);c.entry?c.entry.value=b:(c.entry={next:this.head_,previous:this.head_.previous,head:this.head_,key:a,value:b},c.list.push(c.entry),this.head_.previous.next=c.entry,this.head_.previous=c.entry,this.size++);return this};c.prototype["delete"]=
...
e.length;g++){var f=e[g];if(c!==c&&f.key!==f.key||c===f.key)return{id:d,list:e,index:g,entry:f}}return{id:d,list:e,index:-1,entry:void 0}},g=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},e=function(){var a={};return a.previous=a.next=a.head=a},k=0;return c},"es6-impl","es3");$jscomp.ASSUME_NO_NATIVE_SET=!1;
$jscomp.polyfill("Set",function(a){if(!$jscomp.ASSUME_NO_NATIVE_SET&&function(){if(!a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var c=Object.seal({x:4}),b=new a($jscomp.makeIterator([c]));if(!b.has(c)||1!=b.size||b.add(c)!=b||1!=b.size||b.add({x:4})!=b||2!=b.size)return!1;var g=b.entries(),e=g.next();if(e.done||e.value[0]!=c||e.value[1]!=c)return!1;e=g.next();return e.done||e.value[0]==c||4!=e.value[0].x||e.value[1]!=e.value[0]?!1:g.next().done}catch(k){return!1}}())return a;
...
""),b=b.replace(/\\\"/g,'"'),b=b.replace(/\"\: \"/g,'":"').replace(/\", \"/g,'","').replace(/\"\: \{\"/g,'":{"')):b=a;console.log("QR Code content: "+a);console.log("QR Code processed: "+b);null!==b.match(/^\x7b\"\x70\x72\x6f\x70\x65\x73\x70\"\:\x7b(.*)\x7d\x7d/g)?(d=!0,g=!1,a=b):null===b.match(/^\{(.*)\}/g)&&null===b.match(/\s/g)&&(c=d=!0);console.log("isQRValid (pretest): "+(d?"maybe valid":"invalid"));c&&d&&(console.log("QR Code is maybe encoded. Validating..."),c=CryptoJS.AES.decrypt(b,"propespti2013"),
full_dec=c.toString(CryptoJS.enc.Utf8),g=null!==full_dec.match(/^\{(.*)\}/g)?!0:!1);g&&d?(console.log("QR Code is maybe valid!"),console.log("QR Code is encoded!"),console.log("Checking authencity..."),c=CryptoJS.AES.decrypt(b,"propespti2013"),a=c.toString(CryptoJS.enc.Utf8)):!g&&d&&(console.log("QR Code is maybe valid!"),console.log("QR Code is not encoded!"),console.log("Checking authencity..."),a=b);null!==a.match(/^\x7b\"\x70\x72\x6f\x70\x65\x73\x70\"\:\x7b(.*)\x7d\x7d/g)?(d=!0,console.log("QR Code is valid!")):
...
300)},_pageLoaded:function(){document.getElementById("pageLoader").style.display="none"},_changeTab:function(a){3===a&&(actualScrollId="scrollAreaRejected",actualContentId="contentAreaRejected",actualLiArr=rejected_li_arr,qrScan.newClusterize());$("a.mdl-layout__tab").removeClass("is-active");$('a[href="#scroll-tab-'+a+'"]').addClass("is-active");$(".mdl-layout__tab-panel").removeClass("is-active");document.querySelector("#scroll-tab-"+a).classList.add("is-active")}},checkTab:function(a){a.href.match("#scroll-tab-1")?
actualLiArr=actualContentId=actualScrollId=void 0:a.href.match("#scroll-tab-2")?(actualScrollId="scrollAreaSaved",actualContentId="contentAreaSaved",actualLiArr=saved_li_arr,qrScan.newClusterize()):a.href.match("#scroll-tab-3")&&(actualScrollId="scrollAreaRejected",actualContentId="contentAreaRejected",actualLiArr=rejected_li_arr,qrScan.newClusterize())},newClusterize:function(){clusterize=new Clusterize({rows:actualLiArr,tag:"ul",scrollId:actualScrollId,contentId:actualContentId,no_data_text:"Nenhum bolsista"})},
updateCluster:function(a){clusterize.update(a)},clearHTML:function(a){document.getElementById(a).innerHTML=""},sendResponse:function(a){console.log(a);$.ajax({url:"./classes/access_presence_list.php",type:"POST",data:null,cache:!1,success:function(){console.log("success")},error:function(){console.log("error")}})},sync:function(){qrScan.animate._syncing(!0);qrScan.animate._showToast("Sincronizando...");$.ajax({url:"./classes/retrieve_scholarship_holders.php",success:function(a){var b,c,d,g,e,k=qrScan.data.length,
l=a.length;console.log("\n\n");console.log(a);var f=0;for(;f<k;f++){console.log("data["+f+"]: "+qrScan.data[f][x].nome);if(0===qrScan.data[f][x].synced||void 0===qrScan.data[f][x].synced||1===qrScan.data[f][x].synced||2===qrScan.data[f][x].synced){if(1===qrScan.data[f][x].synced)c=!0,d=!1,e=f,console.log("J\u00e1 sincronizado: "+qrScan.data[f][x].nome);else if(2===qrScan.data[f][x].synced)d=c=!0,console.log("J\u00e1 sincronizado com erro: "+qrScan.data[f][x].nome);else if(0===qrScan.data[f][x].synced||
void 0===qrScan.data[f][x].synced)d=c=!1,console.log("N\u00e3o sincronizado: "+qrScan.data[f][x].nome);var h=0;b:for(;h<l;h++){console.log("    result["+h+"]: "+a[h].nome);if(qrScan.data[f][x].cpf===a[h].cpf)if(console.log("    CPF de "+qrScan.data[f][x].nome+" encontrado na posi\u00e7\u00e3o ["+h+"]"),console.log("    Verificando nome..."),qrScan.data[f][x].nome===a[h].nome){b=!0;d=!1;e=f;g=h;console.log("    "+qrScan.data[f][x].nome+" encontrado na posi\u00e7\u00e3o ["+h+"]");break b}else e=f,console.log("    Nome de "+
qrScan.data[f][x].nome+" n\u00e3o bate com o CPF.");else b=!1,d=!0,e=f,qrScan.data[f][x].nome===a[h].nome&&console.log("    CPF de "+qrScan.data[f][x].nome+" n\u00e3o bate.");c=!0}}!0===b&&!1===c?(qrScan.data[e][x].synced=1,syncArr.push(a[g].id),syncArr=[].concat($jscomp.arrayFromIterable(new Set(syncArr))),syncArr.sort(qrScan.sortNumber),b=JSON.stringify(qrScan.data),enc=CryptoJS.AES.encrypt(b,"propespti2013"),qrScan.sendResponse(qrScan.data[0])):!0===b&&!0===d?(qrScan.data[e][x].synced=1,syncArr.push(a[g].id),
syncArr=[].concat($jscomp.arrayFromIterable(new Set(syncArr))),syncArr.sort(qrScan.sortNumber),qrScan.sendResponse(qrScan.data[0])):!0===b&&!1===d?(qrScan.data[e][x].synced=1,syncArr.push(a[g].id),syncArr=[].concat($jscomp.arrayFromIterable(new Set(syncArr))),syncArr.sort(qrScan.sortNumber),qrScan.sendResponse(qrScan.data[0])):!1===b&&!1===c?qrScan.data[e][x].synced=2:!1===b&&!0===c?qrScan.data[e][x].synced=2:!1===b&&!0===d?qrScan.data[e][x].synced=2:!1===b&&!1===d&&(qrScan.data[e][x].synced=2);c=
b=d=void 0}qrScan.animate._changeSyncStatus();qrScan.animate._syncing(!1);qrScan.animate._showToast("Sincronizado.")},error:function(){qrScan.animate._syncing(!1);qrScan.animate._showToast("Erro ao sincronizar.")}})}},clusterize=new Clusterize({rows:saved_li_arr,tag:"ul",scrollId:"scrollAreaSaved",contentId:"contentAreaSaved",no_data_text:"Nenhum bolsista",callbacks:{clusterChanged:function(){}}});null!==localStorage.getItem("data")&&(qrScan.loadFromLS("data"),qrScan.updateHTMLArray("data"));
