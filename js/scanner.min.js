...
e.length;f++){var g=e[f];if(c!==c&&g.key!==g.key||c===g.key)return{id:d,list:e,index:f,entry:g}}return{id:d,list:e,index:-1,entry:void 0}},e=function(a,c){var b=a.head_;return $jscomp.iteratorPrototype(function(){if(b){for(;b.head!=a.head_;)b=b.previous;for(;b.next!=b.head;)return b=b.next,{done:!1,value:c(b)};b=null}return{done:!0,value:void 0}})},f=function(){var a={};return a.previous=a.next=a.head=a},k=0;return c},"es6-impl","es3");$jscomp.ASSUME_NO_NATIVE_SET=!1;
$jscomp.polyfill("Set",function(a){if(!$jscomp.ASSUME_NO_NATIVE_SET&&function(){if(!a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var b=Object.seal({x:4}),d=new a($jscomp.makeIterator([b]));if(!d.has(b)||1!=d.size||d.add(b)!=d||1!=d.size||d.add({x:4})!=d||2!=d.size)return!1;var e=d.entries(),f=e.next();if(f.done||f.value[0]!=b||f.value[1]!=b)return!1;f=e.next();return f.done||f.value[0]==b||4!=f.value[0].x||f.value[1]!=f.value[0]?!1:e.next().done}catch(k){return!1}}())return a;
...
updateCluster:function(a){clusterize.update(a)},clearHTML:function(a){document.getElementById(a).innerHTML=""},sendResponse:function(a){$.ajax({type:"POST",url:"classes/access_presence_list.php",data:a,cache:!1,success:function(a){console.log("Sincronizado com sucesso");console.log(a);qrScan.animate._changeSyncStatus();qrScan.animate._syncing(!1);qrScan.animate._showToast("Sincronizado.")},error:function(a,c,d){console.log("Erro ao sincronizar");console.log(c);console.log(d)}})},sync:function(){qrScan.animate._syncing(!0);
qrScan.animate._showToast("Sincronizando...");$.ajax({url:"./classes/retrieve_scholarship_holders.php",success:function(a){var b,c,d,e,f=qrScan.data.length,k=a.length;console.log("\n\n");console.log(a);var g=0;for(;g<f;g++){if(1===qrScan.data[g][x].synced)c=!1,e=g;else if(2===qrScan.data[g][x].synced)c=!0;else if(0===qrScan.data[g][x].synced||void 0===qrScan.data[g][x].synced)c=!1;var h=0;b:for(;h<k;h++)if(qrScan.data[g][x].cpf===a[h].cpf)if(qrScan.data[g][x].nome===a[h].nome){b=!0;c=!1;e=g;d=h;break b}else e=
g;else b=!1,c=!0,e=g;!0===b?void 0!==c&&(qrScan.data[e][x].synced=1,qrScan.data[e][x].id_bolsista=a[d].id,syncArr.push(a[d].id),syncArr=[].concat($jscomp.arrayFromIterable(new Set(syncArr))),syncArr.sort(qrScan.sortNumber),b=JSON.stringify(qrScan.data),enc=CryptoJS.AES.encrypt(b,"propespti2013")):void 0!==c&&(qrScan.data[e][x].synced=2);b=c=void 0}qrScan.sendResponse(qrScan.data)},error:function(){qrScan.animate._syncing(!1);qrScan.animate._showToast("Erro ao sincronizar.")}})}},clusterize=new Clusterize({rows:saved_li_arr,
