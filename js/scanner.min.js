...
$jscomp.polyfill("WeakMap",function(a){function b(a){$jscomp.owns(a,d)||$jscomp.defineProperty(a,d,{value:{}})}function c(a){var e=Object[a];e&&(Object[a]=function(a){b(a);return e(a)})}if(function(){if(!a||!Object.seal)return!1;try{var b=Object.seal({}),e=Object.seal({}),c=new a([[b,2],[e,3]]);if(2!=c.get(b)||3!=c.get(e))return!1;c["delete"](b);c.set(e,4);return!c.has(b)&&4==c.get(e)}catch(l){return!1}}())return a;var d="$jscomp_hidden_"+Math.random().toString().substring(2);c("freeze");c("preventExtensions");
c("seal");var f=0,g=function(a){this.id_=(f+=Math.random()+1).toString();if(a){$jscomp.initSymbol();$jscomp.initSymbolIterator();a=$jscomp.makeIterator(a);for(var b;!(b=a.next()).done;)b=b.value,this.set(b[0],b[1])}};g.prototype.set=function(a,c){b(a);if(!$jscomp.owns(a,d))throw Error("WeakMap key fail: "+a);a[d][this.id_]=c;return this};g.prototype.get=function(a){return $jscomp.owns(a,d)?a[d][this.id_]:void 0};g.prototype.has=function(a){return $jscomp.owns(a,d)&&$jscomp.owns(a[d],this.id_)};g.prototype["delete"]=
...
e.length;f++){var g=e[f];if(c!==c&&g.key!==g.key||c===g.key)return{id:d,list:e,index:f,entry:g}}return{id:d,list:e,index:-1,entry:void 0}},f=function(a,b){var c=a.head_;return $jscomp.iteratorPrototype(function(){if(c){for(;c.head!=a.head_;)c=c.previous;for(;c.next!=c.head;)return c=c.next,{done:!1,value:b(c)};c=null}return{done:!0,value:void 0}})},g=function(){var a={};return a.previous=a.next=a.head=a},k=0;return c},"es6-impl","es3");$jscomp.ASSUME_NO_NATIVE_SET=!1;
$jscomp.polyfill("Set",function(a){if(!$jscomp.ASSUME_NO_NATIVE_SET&&function(){if(!a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var c=Object.seal({x:4}),b=new a($jscomp.makeIterator([c]));if(!b.has(c)||1!=b.size||b.add(c)!=b||1!=b.size||b.add({x:4})!=b||2!=b.size)return!1;var f=b.entries(),g=f.next();if(g.done||g.value[0]!=c||g.value[1]!=c)return!1;g=f.next();return g.done||g.value[0]==c||4!=g.value[0].x||g.value[1]!=g.value[0]?!1:f.next().done}catch(k){return!1}}())return a;
...
""),b=b.replace(/\\\"/g,'"'),b=b.replace(/\"\: \"/g,'":"').replace(/\", \"/g,'","').replace(/\"\: \{\"/g,'":{"')):b=a;console.log("QR Code content: "+a);console.log("QR Code processed: "+b);null!==b.match(/^\x7b\"\x70\x72\x6f\x70\x65\x73\x70\"\:\x7b(.*)\x7d\x7d/g)?(d=!0,f=!1,a=b):null===b.match(/^\{(.*)\}/g)&&null===b.match(/\s/g)&&(c=d=!0);console.log("isQRValid (pretest): "+(d?"maybe valid":"invalid"));c&&d&&(console.log("QR Code is maybe encoded. Validating..."),c=CryptoJS.AES.decrypt(b,"propespti2013"),
full_dec=c.toString(CryptoJS.enc.Utf8),f=null!==full_dec.match(/^\{(.*)\}/g)?!0:!1);f&&d?(console.log("QR Code is maybe valid!"),console.log("QR Code is encoded!"),console.log("Checking authencity..."),c=CryptoJS.AES.decrypt(b,"propespti2013"),a=c.toString(CryptoJS.enc.Utf8)):!f&&d&&(console.log("QR Code is maybe valid!"),console.log("QR Code is not encoded!"),console.log("Checking authencity..."),a=b);null!==a.match(/^\x7b\"\x70\x72\x6f\x70\x65\x73\x70\"\:\x7b(.*)\x7d\x7d/g)?(d=!0,console.log("QR Code is valid!")):
...
updateCluster:function(a){clusterize.update(a)},clearHTML:function(a){document.getElementById(a).innerHTML=""},sendResponse:function(a){console.log(a);$.ajax({type:"POST",url:"classes/access_presence_list.php",data:a,cache:!1,success:function(a){console.log("success");console.log(a)},error:function(a,c,d){console.log("error");console.log(c);console.log(d)}})},sync:function(){qrScan.animate._syncing(!0);qrScan.animate._showToast("Sincronizando...");$.ajax({url:"./classes/retrieve_scholarship_holders.php",
success:function(a){var b,c,d,f,g=qrScan.data.length,k=a.length;console.log("\n\n");console.log(a);var e=0;for(;e<g;e++){console.log("data["+e+"]: "+qrScan.data[e][x].nome);if(0===qrScan.data[e][x].synced||void 0===qrScan.data[e][x].synced||1===qrScan.data[e][x].synced||2===qrScan.data[e][x].synced){if(1===qrScan.data[e][x].synced)c=!1,f=e,console.log("J\u00e1 sincronizado: "+qrScan.data[e][x].nome);else if(2===qrScan.data[e][x].synced)c=!0,console.log("J\u00e1 sincronizado com erro: "+qrScan.data[e][x].nome);
else if(0===qrScan.data[e][x].synced||void 0===qrScan.data[e][x].synced)c=!1,console.log("N\u00e3o sincronizado: "+qrScan.data[e][x].nome);var h=0;b:for(;h<k;h++)if(console.log("    result["+h+"]: "+a[h].nome),qrScan.data[e][x].cpf===a[h].cpf)if(console.log("    CPF de "+qrScan.data[e][x].nome+" encontrado na posi\u00e7\u00e3o ["+h+"]"),console.log("    Verificando nome..."),qrScan.data[e][x].nome===a[h].nome){b=!0;c=!1;f=e;d=h;console.log("    "+qrScan.data[e][x].nome+" encontrado na posi\u00e7\u00e3o ["+
h+"]");break b}else f=e,console.log("    Nome de "+qrScan.data[e][x].nome+" n\u00e3o bate com o CPF.");else b=!1,c=!0,f=e,qrScan.data[e][x].nome===a[h].nome&&console.log("    CPF de "+qrScan.data[e][x].nome+" n\u00e3o bate.")}!0===b?void 0!==c&&(qrScan.data[f][x].synced=1,qrScan.data[f][x].id_bolsista=a[d].id,syncArr.push(a[d].id),syncArr=[].concat($jscomp.arrayFromIterable(new Set(syncArr))),syncArr.sort(qrScan.sortNumber),b=JSON.stringify(qrScan.data),enc=CryptoJS.AES.encrypt(b,"propespti2013")):
void 0!==c&&(qrScan.data[f][x].synced=2);b=c=void 0}qrScan.sendResponse(qrScan.data);qrScan.animate._changeSyncStatus();qrScan.animate._syncing(!1);qrScan.animate._showToast("Sincronizado.")},error:function(){qrScan.animate._syncing(!1);qrScan.animate._showToast("Erro ao sincronizar.")}})}},clusterize=new Clusterize({rows:saved_li_arr,tag:"ul",scrollId:"scrollAreaSaved",contentId:"contentAreaSaved",no_data_text:"Nenhum bolsista",callbacks:{clusterChanged:function(){}}});
...
scanner.addListener("inactive",function(){qrScan.animate._loading(!0)});
