...
qrScan.log("QR Code inv\u00e1lido! Escaneie um QR Code pertencente \u00e0 PROPESP."))},animate:{_snap:function(){$("#cameraCanvas").removeClass("snap-anim");$("#cameraCanvas").addClass("snap-anim").one("webkitAnimationEnd oanimationend msAnimationEnd animationend",function(a){$("#cameraCanvas").removeClass("snap-anim")})},_success:function(){var a=document.querySelector(".mdl-js-snackbar");$("#snap-status-toast").removeClass("mdl-snackbar--active");a.MaterialSnackbar.showSnackbar({message:"Dados salvos!"});
$(".error").removeClass("snap-status-in snap-status-out");void 0!=snapTimeout&&clearTimeout(snapTimeout);$(".success").removeClass("snap-status-in snap-status-out").addClass("snap-status-in");snapTimeout=setTimeout(function(){$(".success").removeClass("snap-status-in").addClass("snap-status-out")},3E3)},_error:function(){var a=document.querySelector(".mdl-js-snackbar");$("#snap-status-toast").removeClass("mdl-snackbar--active");a.MaterialSnackbar.showSnackbar({message:"QR Code inv\u00e1lido!"});$(".success").removeClass("snap-status-in snap-status-out");
