...
tag:"ul",scrollId:actualScrollId,contentId:actualContentId,no_data_text:"Nenhum bolsista",callbacks:{clusterChanged:function(){}}})},clearHTML:function(a){document.getElementById(a).innerHTML=""},sync:function(){$("#mdl-syncing-icon").addClass("syncing");$.ajax({url:"./classes/usuarios.php",success:function(a){$("#mdl-syncing-icon").removeClass("syncing");console.log(a)},error:function(){$("#mdl-syncing-icon").removeClass("syncing");console.log("Erro ao sincronizar")}})}},clusterize=new Clusterize({rows:saved_li_arr,
tag:"ul",scrollId:"scrollAreaSaved",contentId:"contentAreaSaved",no_data_text:"Nenhum bolsista",callbacks:{clusterChanged:function(){}}});null!==localStorage.getItem("data")&&(qrScan.loadFromLS("data"),qrScan.updateHTMLArray("data"));null!==localStorage.getItem("rejected")&&(qrScan.loadFromLS("rejected"),qrScan.updateHTMLArray("rejected"));var options={},options=qrScan.initVideoObjectOptions("webcameraPreview"),cameraId=0;qrScan.initScanner(options);
