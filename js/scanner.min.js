...
a.length){var b=a[0];$.each(a,function(a,c){if(-1!=c.name.indexOf("back"))return b=c,!1});scanner.start(b)}else alert("No cameras found.")})},scanStart:function(a){scanner.addListener("scan",function(b){a(b)})},initScanner:function(a){scanner=new Instascan.Scanner(a)}},d={},d=b.initVideoObjectOptions("webcameraPreview");b.initScanner(d);b.initAvaliableCameras(function(){c=1});b.initCamera(c);b.scanStart(function(a){alert(a)})})();
