...
$(".mdl-layout__tab").on("click",function(){this.href.match("#scroll-tab-1")&&!isCameraTabActive?(console.log("Camera activated."),isCameraTabActive=!0,scanner.start(selectedCam)):!this.href.match("#scroll-tab-1")&&isCameraTabActive&&(console.log("Camera deactivated."),isCameraTabActive=!1,setTimeout(function(){scanner.stop()},15E3));this.href.match("#scroll-tab-3")&&setTimeout(function(){document.querySelector(".mdl-layout__content").scrollTop=document.querySelector(".mdl-layout__content").scrollHeight},
100)});
