...
scanStart:function(a){scanner.addListener("scan",function(c){a(c)})},initScanner:function(a){scanner=new Instascan.Scanner(a)},saveScannedData:function(a){a.replace(/\n/gi,"<br>");console.log("Dados lidos: "+a);var c=a.replace(/\n/gi,""),c=c.replace(/\\"/g,'"');console.log("Dados processados: "+c);qrScan.log("Dados processados: "+c);c.match(/^\x7b\"\x70\x72\x6f\x70\x65\x73\x70\"\: \x7b(.*)\x7d\x7d/g)?(qrScan.animate._snap(),qrScan.data.push(JSON.parse(a)),a=JSON.stringify(qrScan.data),console.log("Dados salvos em RAM: "+
...
a)):(alert("QR Code inv\u00e1lido!\n\nEscaneie um QR Code pertencente \u00e0 PROPESP."),console.log("QR Code inv\u00e1lido! Escaneie um QR Code pertencente \u00e0 PROPESP."),qrScan.log("QR Code inv\u00e1lido! Escaneie um QR Code pertencente \u00e0 PROPESP."))},animate:{_snap:function(){var a=document.getElementById("cameraCanvas");$(a).addClass("snap-anim").one("webkitAnimationEnd oanimationend msAnimationEnd animationend",function(a){$(this).removeClass("snap-anim")})}}},options={},options=qrScan.initVideoObjectOptions("webcameraPreview");
