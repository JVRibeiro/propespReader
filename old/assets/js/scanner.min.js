...
new Clusterize({rows:actualLiArr,tag:"ul",scrollId:actualScrollId,contentId:actualContentId,no_data_text:"Nenhum bolsista"})},updateCluster:function(a){clusterize.update(a)},clearHTML:function(a){document.getElementById(a).innerHTML=""},sendResponse:function(a){$.ajax({type:"POST",url:"classes/access_presence_list.php",data:{dados:JSON.stringify(a)},cache:!1,success:function(a){qrScan.onSendSuccess(a)},error:function(a,c,d){qrScan.onSendError(response)}})},onSendSuccess:function(a){qrScan.animate._changeSyncStatus();
qrScan.animate._syncing(!1);qrScan.animate._showToast("Sincronizado.")},onSendError:function(a,b,c){qrScan.animate._changeSyncStatus();qrScan.animate._syncing(!1);qrScan.animate._showToast("Erro ao sincronizar.")},sync:function(){qrScan.animate._syncing(!0);qrScan.animate._showToast("Sincronizando...");$.ajax({url:"./classes/retrieve_scholarship_holders.php",success:function(a){var b,c,d,e,f=qrScan.data.length,k=a.length,g=0;for(;g<f;g++){if(1===qrScan.data[g][x].synced)c=!1,e=g;else if(2===qrScan.data[g][x].synced)c=
!0;else if(0===qrScan.data[g][x].synced||void 0===qrScan.data[g][x].synced)c=!1;var h=0;b:for(;h<k;h++)if(qrScan.data[g][x].cpf===a[h].cpf)if(qrScan.data[g][x].nome===a[h].nome){b=!0;c=!1;e=g;d=h;break b}else e=g;else b=!1,c=!0,e=g;!0===b?void 0!==c&&(qrScan.data[e][x].synced=1,qrScan.data[e][x].id_bolsista=a[d].id,syncArr.push(a[d].id),syncArr=[].concat($jscomp.arrayFromIterable(new Set(syncArr))),syncArr.sort(qrScan.sortNumber),b=JSON.stringify(qrScan.data),enc=CryptoJS.AES.encrypt(b,"propespti2013"),
localStorage.setItem("data",enc)):void 0!==c&&(qrScan.data[e][x].synced=2);b=c=void 0}qrScan.sendResponse(qrScan.data)},error:function(){qrScan.animate._syncing(!1);qrScan.animate._showToast("Erro ao sincronizar.")}})}},clusterize=new Clusterize({rows:saved_li_arr,tag:"ul",scrollId:"scrollAreaSaved",contentId:"contentAreaSaved",no_data_text:"Nenhum bolsista",callbacks:{clusterChanged:function(){}}});null!==localStorage.getItem("data")&&(qrScan.loadFromLS("data"),qrScan.updateHTMLArray("data"));
